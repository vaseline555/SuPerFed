...
# SCAFFOLD
python3 main.py --exp_name scaffold_mnist_patho_50 --tb_port 28931 \
--dataset MNIST --is_small --in_channels 1 --num_classes 10 \
--algorithm scaffold --model_name TwoNN --fc_type LinesLinear \
--C 0.2 --K 50 --R 500 --E 10 --B 10 \
--split_type pathological --shard_size 600 \
--eval_every 500 &
python3 main.py --exp_name scaffold_mnist_patho_100 --tb_port 28932 \
--dataset MNIST --is_small --in_channels 1 --num_classes 10 \
--algorithm scaffold --model_name TwoNN --fc_type LinesLinear \
--C 0.1 --K 100 --R 500 --E 10 --B 10 \
--split_type pathological --shard_size 300 \
--eval_every 500 &
python3 main.py --exp_name scaffold_mnist_patho_500 --tb_port 28933  \
--dataset MNIST --is_small --in_channels 1 --num_classes 10 \
--algorithm scaffold --model_name TwoNN --fc_type LinesLinear \
--C 0.02 --K 500 --R 500 --E 10 --B 10 \
--split_type pathological --shard_size 60 \
...
--C 0.2 --K 50 --R 500 --E 10 --B 10 --lr 0.01 --mu 15 \
--split_type pathological --shard_size 600 --n_jobs 10 \
--eval_every 500 &
python3 main.py --exp_name pfedme_mnist_patho_100 --tb_port 6665 \
--dataset MNIST --is_small --in_channels 1 --num_classes 10 \
--algorithm pfedme --model_name TwoNN --fc_type LinesLinear \
--C 0.1 --K 100 --R 500 --E 10 --B 10 --lr 0.01 --mu 15 \
--split_type pathological --shard_size 300 --n_jobs 10 \
--eval_every 500 &
python3 main.py --exp_name pfedme_mnist_patho_500 --tb_port 6666 \
--dataset MNIST --is_small --in_channels 1 --num_classes 10 \
--algorithm pfedme --model_name TwoNN --fc_type LinesLinear \
--C 0.02 --K 500 --R 500 --E 10 --B 10 --lr 0.01 --mu 15 \
--split_type pathological --shard_size 60 --n_jobs 10 \
--eval_every 500 &
...
--C 0.2 --K 50 --R 500 --E 10 --B 10 --tau 10 \
--split_type pathological --shard_size 600 --n_jobs 10 \
--eval_every 500 &
...
--dataset MNIST --is_small --in_channels 1 --num_classes 10 \
--algorithm fedrep --model_name TwoNN \
--C 0.02 --K 500 --R 500 --E 10 --B 10 --tau 10 \
--split_type pathological --shard_size 60 --n_jobs 10 \
--eval_every 500 &
...
--C 0.2 --K 50 --R 500 --E 10 --B 10 --tau 10 --mu 1 \
--split_type pathological --shard_size 600 --n_jobs 10 \
--eval_every 500 &
...
--dataset MNIST --is_small --in_channels 1 --num_classes 10 \
--algorithm ditto --model_name TwoNN --fc_type LinesLinear \
--C 0.02 --K 500 --R 500 --E 10 --B 10 --tau 10 --mu 1 \
--split_type pathological --shard_size 60 --n_jobs 10 \
--eval_every 500 &
...
--C 0.2 --K 50 --R 500 --E 10 --B 10 --L 0.4 --nu 5 --mu 0.01 \
--split_type pathological --shard_size 600 \
--eval_every 500 &
...
--dataset MNIST --is_small --in_channels 1 --num_classes 10 \
--algorithm superfed-mm --model_name TwoNN --fc_type LinesLinear \
--C 0.02 --K 500 --R 500 --E 10 --B 10 --L 0.4 --nu 5 --mu 0.01 \
--split_type pathological --shard_size 60 \
--eval_every 500 &
...
--C 0.2 --K 50 --R 500 --E 10 --B 10 --L 0.4 --nu 2 --mu 0.01 \
--split_type pathological --shard_size 600 \
--eval_every 500 &
...
--dataset MNIST --is_small --in_channels 1 --num_classes 10 \
--algorithm superfed-lm --model_name TwoNN --fc_type LinesLinear \
--C 0.02 --K 500 --R 500 --E 10 --B 10 --L 0.4 --nu 2 --mu 0.01 \
--split_type pathological --shard_size 60 \
--eval_every 500 &
...
# SCAFFOLD
python3 main.py --exp_name scaffold_cifar10_patho_50 --tb_port 6661 \
--dataset CIFAR10 --is_small --in_channels 3 --num_classes 10 \
...
--dataset CIFAR10 --is_small --in_channels 3 --num_classes 10 \
--algorithm apfl --model_name TwoCNN --fc_type LinesLinear --conv_type LinesConv \
--C 0.2 --K 50 --R 500 --E 10 --B 10 --mu 15 \
--split_type pathological --shard_size 500 --n_jobs 10 \
--eval_every 500 &
...
--dataset CIFAR10 --is_small --in_channels 3 --num_classes 10 \
--algorithm apfl --model_name TwoCNN --fc_type LinesLinear --conv_type LinesConv \
--C 0.02 --K 500 --R 500 --E 10 --B 10 --mu 15  \
--split_type pathological --shard_size 50 --n_jobs 10 \
--eval_every 500 &
