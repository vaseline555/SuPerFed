...
--dataset FEMNIST --is_small --in_channels 1 --num_classes 62 \
--algorithm superfed-mm --model_name TwoNN --fc_type LinesLinear --bn_type LinesBN --conv_type LinesConv \
--C 0.007 --R 1000 --E 5 --B 10 --lr 0.001  \
--split_type realistic \
--eval_every 1000
...
--dataset FEMNIST --is_small --in_channels 1 --num_classes 62 \
--algorithm superfed-lm --model_name TwoNN --fc_type LinesLinear --bn_type LinesBN --conv_type LinesConv \
--C 0.007 --R 1000 --E 5 --B 10 --lr 0.001  \
--split_type realistic \
--eval_every 1000
