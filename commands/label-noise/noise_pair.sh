...
--dataset MNIST --is_small --in_channels 1 --num_classes 10 \
--label_noise --noise_type pair --noise_rate 0.8 \
--algorithm fedavg --model_name ResNet18 \
--C 0.1 --K 100 --R 500 --E 5 --B 10 \
--split_type iid \
--eval_every 100
...
python3 main.py --exp_name fedavg_cifar10_patho_noise_pair_04 --tb_port 14924 \
--dataset CIFAR10 --is_small --in_channels 3 --num_classes 10 \
--label_noise --noise_type pair --noise_rate 0.4 \
--algorithm fedavg --model_name MobileNetv2 \
--C 0.1 --K 100 --R 500 --E 5 --B 10 \
...
python3 main.py --exp_name fedavg_cifar10_patho_noise_pair_08 --tb_port 14925 \
--dataset CIFAR10 --is_small --in_channels 3 --num_classes 10 \
--label_noise --noise_type pair --noise_rate 0.8 \
--algorithm fedavg --model_name MobileNetv2 \
--C 0.1 --K 100 --R 500 --E 5 --B 10 \
