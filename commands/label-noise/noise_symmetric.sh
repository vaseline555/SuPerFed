...
--C 0.1 --K 100 --R 500 --E 10 --B 10 --n_jobs 10 \
--split_type dirichlet --alpha 100.0 \
--eval_every 500 &
python3 main.py --exp_name fedavg_mnist_noise_symmetric_06 --tb_port 2 \
--dataset MNIST --is_small --in_channels 1 --num_classes 10 \
...
# SCAFFOLD
python3 main.py --exp_name scaffold_mnist_noise_symmetric_02 --tb_port 1 \
--dataset MNIST --is_small --in_channels 1 --num_classes 10 \
--label_noise --noise_type symmetric --noise_rate 0.2 \
...
--split_type dirichlet --alpha 100.0 \
--eval_every 500 &
python3 main.py --exp_name scaffold_mnist_noise_symmetric_06 --tb_port 2 \
--dataset MNIST --is_small --in_channels 1 --num_classes 10 \
--label_noise --noise_type symmetric --noise_rate 0.6 \
--algorithm scaffold --model_name TwoNN --fc_type LinesLinear \
--C 0.1 --K 100 --R 500 --E 10 --B 10 --n_jobs 10 \
...
--C 0.1 --K 100 --R 500 --E 10 --B 10 --mu 15 --n_jobs 10 \
--split_type dirichlet --alpha 100.0 \
--eval_every 500 &
...
--C 0.1 --K 100 --R 500 --E 10 --B 10 --n_jobs 10 --tau 10 --mu 1 \
--split_type dirichlet --alpha 100.0 \
--eval_every 500 &
...
--C 0.1 --K 100 --R 500 --E 10 --B 10 --n_jobs 10 --tau 10 \
--split_type dirichlet --alpha 100.0 \
--eval_every 500 &
...
# SCAFFOLD
python3 main.py --exp_name scaffold_cifar10_noise_symmetric_02 --tb_port 11 \
--dataset CIFAR10 --is_small --in_channels 3 --num_classes 10 \
--label_noise --noise_type symmetric --noise_rate 0.2 \
...
--split_type dirichlet --alpha 100.0 \
--eval_every 500 &
python3 main.py --exp_name scaffold_cifar10_noise_symmetric_06 --tb_port 22 \
--dataset CIFAR10 --is_small --in_channels 3 --num_classes 10 \
--label_noise --noise_type symmetric --noise_rate 0.6 \
--algorithm scaffold --model_name TwoCNN --fc_type LinesLinear --conv_type LinesConv \
--C 0.1 --K 100 --R 500 --E 10 --B 10 --n_jobs 10 \
